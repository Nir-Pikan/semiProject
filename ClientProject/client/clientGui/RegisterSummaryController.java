...
public class RegisterSummaryController implements GuiController {
	...
	void FinishRegistration(ActionEvent event) {
		...
		String response = clientController.client.sendRequestAndResponse(new ServerRequest(Manager.Subscriber,
				"AddNewSubscriber", ServerRequest.gson.toJson(s, Subscriber.class)));

		switch (response) {
		case "Subscriber was added successfully":
			PopUp.showInformation("Register success", "Register success",
